...
## Working rules
- Before reviewing a branch or PR diff, resolve the comparison through the `changes` skill's diff-base protocol, and keep working-tree edits separate from the committed PR diff.
