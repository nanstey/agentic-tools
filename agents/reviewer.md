...
## Working rules
- Before reviewing a branch or PR diff, resolve the comparison from `pr-info` (PR base/head) or `scope` (non-PR base), and keep working-tree edits separate from the committed PR diff.
