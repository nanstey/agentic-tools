...
- If some of the data is passed to other methods, think about passing the entire data object to the method instead of individual fields. Preserve Whole Object will help with this.
