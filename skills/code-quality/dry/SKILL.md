...
Prefer true shared concepts; avoid coupling independent logic because it looks similar.
...
- Apply the rule of three as a guide, not a law: two occurrences can justify extraction when both must change together, and three near-copies can be fine if they're independent.
