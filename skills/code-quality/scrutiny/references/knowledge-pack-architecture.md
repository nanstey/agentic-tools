...
Keep `questions/` as Scrutiny's general-purpose routing layer. Use `packs/` for compact, source-backed overlays that add specialist tradeoffs without loading a book or a large question bank for every task.
