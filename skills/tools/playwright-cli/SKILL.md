---
name: playwright-cli
description: Automate a browser from the CLI — navigate, interact, snapshot, screenshot, record video, mock network, and run or generate Playwright tests. Use when a task needs real browser actions such as capturing UI, testing web pages, or scripted interactions via the playwright-cli tool.
user-invocable: true
