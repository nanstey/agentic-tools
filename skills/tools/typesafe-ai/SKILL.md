---
name: typesafe-ai
description: Builds AI-powered software with TypeSafe System One models (Jev) by turning natural language and application state into typed judgments and probabilities that code composes. Use when a feature needs programmable common sense, when brainstorming what AI could make possible in an app, or when an LLM prompt-and-parse step could become a structured decision such as routing, ranking, extraction, or verification.
user-invocable: true
